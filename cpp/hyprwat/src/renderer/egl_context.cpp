...
zEGLContext::zEGLContext(wl_display* display) : display(display) {
...
bool zEGLContext::createWindowSurface(wl_surface* surface, int width, int height) {
...
void zEGLContext::makeCurrent() { eglMakeCurrent(egl_display, egl_surface, egl_surface, egl_context); }

void zEGLContext::swapBuffers() { eglSwapBuffers(egl_display, egl_surface); }
